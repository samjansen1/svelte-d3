    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 22, 4, 416);
    			attr_dev(header, "class", "svelte-18axcrr");
    			add_location(header, file$4, 21, 0, 403);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 109, 8, 2960);
    			attr_dev(form, "class", "svelte-1jkqc2f");
    			add_location(form, file, 64, 4, 1667);
    			attr_dev(main, "class", "svelte-1jkqc2f");
    			add_location(main, file, 63, 0, 1656);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
