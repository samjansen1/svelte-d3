    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$6, 22, 4, 416);
    			attr_dev(header, "class", "svelte-18axcrr");
    			add_location(header, file$6, 21, 0, 403);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (/*mode*/ ctx[3] + " " + /*colour*/ ctx[4] + " svelte-1i3gaew"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$5, 90, 4, 1662);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*mode, colour*/ 24 && button_class_value !== (button_class_value = "" + (/*mode*/ ctx[3] + " " + /*colour*/ ctx[4] + " svelte-1i3gaew"))) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$5, 87, 4, 1546);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 14, 0, 301);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	button1 = new Button({
    			props: {
    				...
    				caption: /*isFav*/ ctx[7] ? "Unfavourite" : "Favourite"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 78, 4, 1152);
    			attr_dev(h2, "class", "svelte-1o0f0ir");
    			add_location(h2, file$3, 84, 4, 1249);
    			attr_dev(p0, "class", "svelte-1o0f0ir");
    			add_location(p0, file$3, 85, 4, 1273);
    			attr_dev(header, "class", "svelte-1o0f0ir");
    			add_location(header, file$3, 77, 2, 1139);
    			...
    			add_location(img, file$3, 88, 4, 1328);
    			attr_dev(div0, "class", "image svelte-1o0f0ir");
    			add_location(div0, file$3, 87, 2, 1304);
    			attr_dev(p1, "class", "svelte-1o0f0ir");
    			add_location(p1, file$3, 91, 4, 1400);
    			attr_dev(div1, "class", "content svelte-1o0f0ir");
    			add_location(div1, file$3, 90, 2, 1374);
    			attr_dev(footer, "class", "svelte-1o0f0ir");
    			add_location(footer, file$3, 93, 2, 1432);
    			attr_dev(article, "class", "svelte-1o0f0ir");
    			add_location(article, file$3, 76, 0, 1127);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*isFav*/ 128) button1_changes.caption = /*isFav*/ ctx[7] ? "Unfavourite" : "Favourite";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$2, 21, 0, 355);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 48, 8, 978);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 46, 8, 903);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 43, 4, 759);
    			attr_dev(div, "class", "form-control svelte-l9ewvz");
    			add_location(div, file$1, 42, 0, 728);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(form, "class", "svelte-1jkqc2f");
    			add_location(form, file, 78, 4, 2235);
    			attr_dev(main, "class", "svelte-1jkqc2f");
    			add_location(main, file, 77, 0, 2224);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
