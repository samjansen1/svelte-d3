...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 22, 4, 416);
    			attr_dev(header, "class", "svelte-18axcrr");
    			add_location(header, file$3, 21, 0, 403);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['id', 'title', 'subtitle', 'description', 'imageUrl', 'address', 'email'];
    	...
    	return [title, subtitle, description, imageUrl, address, email, id];
    }
    ...
    function create_each_block(ctx) {
    	...
    	meetupitem = new MeetupItem({
    			props: {
    				id: /*m*/ ctx[1].id,
    				title: /*m*/ ctx[1].title,
    				subtitle: /*m*/ ctx[1].subtitle,
    				description: /*m*/ ctx[1].description,
    				imageUrl: /*m*/ ctx[1].imageUrl,
    				address: /*m*/ ctx[1].address,
    				email: /*m*/ ctx[1].contactEmail
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*meetups*/ 1) meetupitem_changes.id = /*m*/ ctx[1].id;
    			if (dirty & /*meetups*/ 1) meetupitem_changes.title = /*m*/ ctx[1].title;
    			if (dirty & /*meetups*/ 1) meetupitem_changes.subtitle = /*m*/ ctx[1].subtitle;
    			if (dirty & /*meetups*/ 1) meetupitem_changes.description = /*m*/ ctx[1].description;
    			if (dirty & /*meetups*/ 1) meetupitem_changes.imageUrl = /*m*/ ctx[1].imageUrl;
    			if (dirty & /*meetups*/ 1) meetupitem_changes.address = /*m*/ ctx[1].address;
    			if (dirty & /*meetups*/ 1) meetupitem_changes.email = /*m*/ ctx[1].contactEmail;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file, 59, 12, 1622);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "title");
    			add_location(input0, file, 60, 12, 1667);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file, 58, 8, 1583);
    			attr_dev(label1, "for", "subtitle");
    			add_location(label1, file, 63, 12, 1780);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "subtitle");
    			add_location(input1, file, 64, 12, 1831);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file, 62, 8, 1741);
    			attr_dev(label2, "for", "description");
    			add_location(label2, file, 67, 12, 1950);
    			attr_dev(textarea, "rows", "3");
    			attr_dev(textarea, "id", "description");
    			add_location(textarea, file, 68, 12, 2007);
    			attr_dev(div2, "class", "form-control");
    			add_location(div2, file, 66, 8, 1911);
    			attr_dev(label3, "for", "imageUrl;");
    			add_location(label3, file, 71, 12, 2132);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "imageUrl");
    			add_location(input2, file, 72, 12, 2185);
    			attr_dev(div3, "class", "form-control");
    			add_location(div3, file, 70, 8, 2093);
    			attr_dev(label4, "for", "address");
    			add_location(label4, file, 75, 12, 2304);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "id", "address");
    			add_location(input3, file, 76, 12, 2353);
    			attr_dev(div4, "class", "form-control");
    			add_location(div4, file, 74, 8, 2265);
    			attr_dev(label5, "for", "email");
    			add_location(label5, file, 79, 12, 2470);
    			attr_dev(input4, "type", "email");
    			attr_dev(input4, "id", "email");
    			add_location(input4, file, 80, 12, 2516);
    			attr_dev(div5, "class", "form-control");
    			add_location(div5, file, 78, 8, 2431);
    			attr_dev(button, "type", "submit");
    			add_location(button, file, 82, 8, 2591);
    			add_location(form, file, 57, 4, 1531);
    			attr_dev(main, "class", "svelte-r5b0o4");
    			add_location(main, file, 56, 0, 1520);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input2, /*imageUrl*/ ctx[3]);
    			append_dev(form, t12);
    			...
    			set_input_value(input4, /*email*/ ctx[5]);
    			append_dev(form, t18);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*addMeetup*/ ctx[7]), false, true, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*imageUrl*/ 8 && input2.value !== /*imageUrl*/ ctx[3]) {
    				set_input_value(input2, /*imageUrl*/ ctx[3]);
    			}
    			...
    			if (dirty & /*email*/ 32 && input4.value !== /*email*/ ctx[5]) {
    				set_input_value(input4, /*email*/ ctx[5]);
    			}
