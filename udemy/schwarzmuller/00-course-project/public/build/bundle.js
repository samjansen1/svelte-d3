    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 88, 4, 1527);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 86, 4, 1491);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 73, 4, 995);
    			attr_dev(h2, "class", "svelte-1o0f0ir");
    			add_location(h2, file$3, 74, 4, 1016);
    			attr_dev(p0, "class", "svelte-1o0f0ir");
    			add_location(p0, file$3, 75, 4, 1040);
    			attr_dev(header, "class", "svelte-1o0f0ir");
    			add_location(header, file$3, 72, 2, 982);
    			...
    			add_location(img, file$3, 78, 4, 1095);
    			attr_dev(div0, "class", "image svelte-1o0f0ir");
    			add_location(div0, file$3, 77, 2, 1071);
    			attr_dev(p1, "class", "svelte-1o0f0ir");
    			add_location(p1, file$3, 81, 4, 1167);
    			attr_dev(div1, "class", "content svelte-1o0f0ir");
    			add_location(div1, file$3, 80, 2, 1141);
    			attr_dev(footer, "class", "svelte-1o0f0ir");
    			add_location(footer, file$3, 83, 2, 1199);
    			attr_dev(article, "class", "svelte-1o0f0ir");
    			add_location(article, file$3, 71, 0, 970);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 48, 8, 955);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 46, 8, 880);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 43, 4, 736);
    			attr_dev(div, "class", "form-control svelte-l9ewvz");
    			add_location(div, file$1, 42, 0, 705);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 65, 4, 1712);
    			attr_dev(main, "class", "svelte-1jkqc2f");
    			add_location(main, file, 64, 0, 1701);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
