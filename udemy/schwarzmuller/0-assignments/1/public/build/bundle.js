...
var app = (function () {
    ...
    /* src/Goal.svelte generated by Svelte v3.59.2 */

    const file$1 = "src/Goal.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1yr8dxu");
    			toggle_class(h1, "highlight", /*courseGoal*/ ctx[0].includes('!'));
    			add_location(h1, file$1, 10, 0, 105);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Goal> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input = element("input");
    			t12 = space();
    			create_component(goal.$$.fragment);
    			add_location(h1, file, 6, 0, 80);
    			add_location(p, file, 8, 0, 101);
    			add_location(li0, file, 11, 2, 135);
    			add_location(li1, file, 12, 2, 207);
    			add_location(li2, file, 13, 2, 253);
    			add_location(li3, file, 16, 2, 364);
    			add_location(ol, file, 10, 0, 128);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Course Goal");
    			add_location(input, file, 21, 0, 471);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(goal, target, anchor);
    			current = true;
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			const goal_changes = {};
    			if (dirty & /*courseGoal*/ 1) goal_changes.courseGoal = /*courseGoal*/ ctx[0];
    			goal.$set(goal_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(goal.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(goal.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(h1);
    			...
    			destroy_component(goal, detaching);
    			mounted = false;
    			dispose();
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Goal, courseGoal });
