    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 26, 0, 453);
    			add_location(button, file, 29, 0, 601);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 31, 0, 693);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button, "click", /*increaseAge*/ ctx[3], false, false, false, false),
